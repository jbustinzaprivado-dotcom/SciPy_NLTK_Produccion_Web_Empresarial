  ...
  return <div className="contact-landing theme-eucalyptus">
    ...
    <header className="landing-header"><div className="landing-container landing-nav">
      ...
      <nav aria-label="Navegación pública">
        <a href="#nosotros">Nosotros</a><a href="#servicios">Servicios</a><a className="landing-button" href="#contacto">Contáctenos <Icon name="arrow" size={18} /></a>
      <SessionAccess /></nav>
    </div></header>
    <main>
      <section className="landing-hero"><div className="landing-container landing-hero-grid">
        <div><p className="landing-kicker">TECNOLOGÍA · DATOS · PERSONAS</p><h1>Soluciones inteligentes.<br /><span>Conversaciones que importan.</span></h1><p className="landing-intro">Tu próximo paso empieza con una conversación. Conectamos tecnología y datos para ayudar a tu empresa a crecer.</p><a className="landing-button" href="#contacto">Hablemos de tu proyecto <Icon name="arrow" size={18} /></a></div>
        <aside className="landing-promise"><span className="landing-orbit" aria-hidden="true"><Icon name="message" size={48} /></span><p className="landing-kicker">UN EQUIPO, MÁS POSIBILIDADES</p><h2>La tecnología empieza<br />por escucharte.</h2><ul><li>Soluciones según las necesidades de tu empresa</li><li>Desarrollo, soporte y datos en un solo lugar</li><li>Un enfoque cercano y personalizado</li></ul></aside>
      </div></section>
